...
var (
	...
	ChangeOrdersColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeEnum, Enums: []string{"draft", "pending", "approved", "rejected", "applying", "done", "failed", "rolled_back"}, Default: "draft"},
	...
	DeployTasksColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "state", Type: field.TypeEnum, Enums: []string{"pending", "running", "succeeded", "failed", "rolled_back", "skipped"}, Default: "pending"},
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{DeployTasksColumns[10]},
				RefColumns: []*schema.Column{ChangeOrdersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "deploy_tasks_nodes_deploy_tasks",
				Columns:    []*schema.Column{DeployTasksColumns[11]},
				RefColumns: []*schema.Column{NodesColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
