...
var (
	...
	SecurityEventsColumns = []*schema.Column{
		...
		{Name: "level", Type: field.TypeEnum, Enums: []string{"INFO", "WARN", "CRITICAL"}},
		{Name: "node", Type: field.TypeString, Nullable: true},
		{Name: "sample", Type: field.TypeString, Nullable: true, Size: 2147483647},
		{Name: "handled", Type: field.TypeBool, Default: false},
		{Name: "action", Type: field.TypeEnum, Enums: []string{"pending", "blocked", "ignored"}, Default: "pending"},
		{Name: "created_at", Type: field.TypeTime},
	}
