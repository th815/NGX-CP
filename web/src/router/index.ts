...
const routes: RouteRecordRaw[] = [
  { path: '/', redirect: '/dashboard' },
  {
    ...
    children: [
      ...
      { path: 'configs', name: 'configs', component: () => import('@/views/Configs.vue'), meta: { title: '配置中心', group: '配置' } },
      { path: 'deploy', name: 'deploy', component: () => import('@/views/Deploy.vue'), meta: { title: '发布任务', group: '配置' } },
      { path: 'certs', name: 'certs', component: () => import('@/views/certs/Certs.vue'), meta: { title: '证书管理', group: '配置' } },
      { path: 'backup', name: 'backup', component: () => import('@/views/Placeholder.vue'), meta: { title: '备份恢复', group: '配置' } },
      { path: 'lvs', name: 'lvs', component: () => import('@/views/lvs/Topology.vue'), meta: { title: 'LVS 管理', group: '网络' } },
      { path: 'logs', name: 'logs', component: () => import('@/views/Logs.vue'), meta: { title: '日志中心', group: '观测' } },
      { path: 'security', name: 'security', component: () => import('@/views/Security.vue'), meta: { title: '安全预警', group: '观测' } },
